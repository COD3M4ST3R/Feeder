    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        send.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                if(t.isEmpty())
                {
                    Toast.makeText(getContext(), "Please enter the problem.", Toast.LENGTH_SHORT).show();
                }
                ...
                else
                {
                    ...
                    builder.setPositiveButton("Send", new DialogInterface.OnClickListener()
                    {
                        ...
                        public void onClick(DialogInterface dialog, int which)
                        {
                            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Support").child("Problems");

                            HashMap<Object, String> hashMap = new HashMap<>();
                            hashMap.put("user", FirebaseAuth.getInstance().getCurrentUser().getUid());
                            hashMap.put("problem", t);
